...
describe Paralyze::Runner::MultiProcessExampleGroupRunner, "#spec_file_paths" do
  before(:each) do
    options = [SpecHelper.fixtures_path,"-p","**/*.rb"]    
    @multi_process_example_group_runner = Paralyze::Runner::MultiProcessExampleGroupRunner.new(options)    
  end
